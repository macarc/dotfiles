keys = {
        'normal': {
            ...
            'gh': 'set-cmd-text :open {url:pretty}',
            'H': 'set-cmd-text -s :open -t',
            'gH': 'set-cmd-text :open -t -r {url:pretty}',
            'xh': 'set-cmd-text -s :open -b',
            'xH': 'set-cmd-text :open -b -r {url:pretty}',
            'wh': 'set-cmd-text -s :open -w',
            'wH': 'set-cmd-text :open -w {url:pretty}',
            '/': 'set-cmd-text /',
            '?': 'set-cmd-text ?',
            ';': 'set-cmd-text :',
            'ga': 'open -t',
            ...
            ':i': 'hint images',
            ':I': 'hint images tab',
            ':h': 'hint links fill :open {hint-url}',
            ':H': 'hint links fill :open -t -r {hint-url}',
            ':y': 'hint links yank',
